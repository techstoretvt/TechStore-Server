...
const initAppRoute = (app) => {
    ...
    router.get(routes.getNewCollectionProduct, appController.getNewCollectionProduct)
    router.get(routes.getProductFlycam, appController.getProductFlycam)
    router.get(routes.getListProductMayLike, appController.getListProductMayLike)
    router.get(routes.getEvaluateByIdProduct, appController.getEvaluateByIdProduct)
